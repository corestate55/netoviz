...
export default class SingleVisualizerBase extends BaseContainer {
  ...
  _isFamilyAggregated(node) {
    return this._isAggregated(node) && node.family && node.family.relation
  }

  _isParentsAggregated(node) {
    return this._isFamilyAggregated(node) && node.family.relation !== 'children'
  }
