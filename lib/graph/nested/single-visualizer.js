...
class SingleNestedGraphVisualizer extends SingleVisualizerBase {
   ...
   * @param {Array<GraphNode>} nodes - Nodes.
   ...
   * @param {Array<GraphNode>} nodes - Nodes. (node-type nodes)
   * @private
   */
  _makeNodes(nodes) {
    this.svgGrp
   ...
   * @param {Array<GraphNode>} tps - Term-points. (tp-type node)
   * @private
   */
  _makeTps(tps) {
    this.svgGrp
   ...
   * @param {Array<GraphNode>} tps - Term-points. (tp-type nodes)
   * @private
   */
  _makeTpLabels(tps) {
    this.svgGrp
