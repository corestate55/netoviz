...
class OperationalNestedGraphVisualizer extends SingleNestedGraphVisualizer {
   ...
   * @returns {Array<NestedGraphNodeData>} Root nodes on grid.
   * @private
   */
   ...
   * @returns {NestedGraphNodeData} Node.
   * @protected
   */
   ...
   * @returns {Array<NestedGraphNodeData>} Nodes.
   * @protected
   */
   ...
   * @param {NestedGraphNodeData} rootNode - Node to update.
   * @private
   */
   ...
   * @param {NestedGraphNodeData} node - Node.
   * @returns {Array<NestedGraphNodeData>} Term-points. (tp-type nodes)
   * @private
   */
  _tpsInNode(node) {
   ...
   * @param {NestedGraphNodeData} tp - Term-point to update.
   * @private
   */
   ...
   * @param {NestedGraphNodeData} node - Node.
   * @returns {Array<NestedGraphNodeData>} Children of node.
   * @private
   */
   ...
   * @param {NestedGraphNodeData} rootNode ^ Target root node.
   ...
   * @param {NestedGraphNodeData} d - Clicked Node.
   * @interface
   * @protected
   */
  nodeClickHook(d) {
