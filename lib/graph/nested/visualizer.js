 ...
 * @extends {OperationalNestedGraphVisualizer}
 */
class NestedGraphVisualizer extends OperationalNestedGraphVisualizer {
  /**
   * @override
   */
   ...
   * @param {Array<NestedGraphNodeData>} alertNodes - Nodes to highlight.
   * @private
   */
   ...
   * @param {Array<NestedGraphNodeData>} alertNodes - Operative nodes to highlight.
   * @private
   */
...
export default NestedGraphVisualizer
