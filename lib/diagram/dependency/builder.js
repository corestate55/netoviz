 ...
 * @extends {DiagramBase}
 */
class DependencyDiagramBuilder extends DiagramBase {
  /**
   ...
   * @private
   */
  _makeNetworkLabels(topologyData, origin) {
    return origin
      .selectAll('text')
      .data(topologyData)
      .enter()
  ...
  makeAllDiagramElements(topologyData) {
    ...
    this._makeNetworkLabels(topologyData, networkLabelsGroupSelection)
