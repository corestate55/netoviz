...
class TooltipCreator {
   ...
   * @param {function} tooltipAnchorClickCallback - Function to make anchors in tooltip.
   * @private
   */
   ...
   * @param {function} [tooltipAnchorClickCallback] - Callback for aggregated-node tooltip.
