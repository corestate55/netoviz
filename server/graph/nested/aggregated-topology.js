 ...
 * @extends {DeepNestedTopology}
 */
class AggregatedTopology extends DeepNestedTopology {
  /**
   * Replace aggregated children paths to aggregated node path.
   * @param {DeepNestedNode} targetNode - Target node.
   * @param {Array<DeepNestedNode>} childNodes - To be replaced nodes.
   *     (children of target)
   * @param {AggregatedNestedNode} aggregatedNode - Replacement. (aggregated node)
   * @private
   */
   ...
   * @param {DeepNestedNode} targetNode - Target node.
   * @param {Array<DeepNestedNode>} childNodes - Children to be aggregated.
   * @param {CombinedClassifier} combinedClassifier - Classifier
   * @returns {AggregatedNestedNode} Aggregated Node
   * @private
   */
   ...
   * @param {Array<DeepNestedNode>} nodes - Nodes.
   ...
   * @param {Array<DeepNestedNode>} childNodes - Nodes to be classified.
...
export default AggregatedTopology
